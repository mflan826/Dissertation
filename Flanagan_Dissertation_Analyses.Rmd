...
Process d1 through chunks 1 through 6. Then, find and replace "d1" chunks 1 through 5 below. Run the modified chunks to clean each site file EXCEPT for d8, which is a charter. Charter school data is structured slightly different and needs to be cleaned separately. See chunks 7 through 12 for cleaning charter data. Each replacement should be for 51 occurances. Less or more means there is an error and something was changed.
...
#EFA to find items with strongest factor loadings on transition single dimension of transition planning
