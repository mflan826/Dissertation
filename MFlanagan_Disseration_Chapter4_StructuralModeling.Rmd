...
SQIthreedomainCFIR <- joined %>% select(c(s2.1,s2.2,s2.3,s2.4,s2.5,s2.6,s2.7,s2.8,
                                      s4.1,s4.2,s4.3,s4.4,
                                      s8.1,s8.2,s8.3,s8.4,s8.5,s8.6,s8.6,s8.7,s8.8,s8.9,s8.10,s8.11,s8.12,s8.13,
                                      Q4ADAPT1,Q4ACCESS2,Q2ADAPT1,Q2ACCESS2,Q8ADAPT1,Q8ACCESS2))
...
threedomainCIFRpoly <- polychoric(SQIthreedomainCFIR,smooth=TRUE,global = TRUE, na.rm = TRUE, delete = TRUE)
